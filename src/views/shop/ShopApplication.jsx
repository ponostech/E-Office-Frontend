...
const style = {
  ...
  formControl: {label: {whiteSpace: "pre-line"}},
...
class ShopApplication extends Component {
  ...
  handleSelect = (identifier, value) => {
    switch (identifier) {
      case "trade":
        ...
        if (fla) this.setState({documents: this.state.flaDocuments});
        else this.setState({documents: this.state.noFlaDocuments});
        break;
      case "type":
  ...
  invalid = () => {
    return Boolean(this.state.nameError) || Boolean(this.state.typeError) || Boolean(this.state.addressError)
        ...
        || !Boolean(this.state.agree) || !this.validateDocument();
  }
                    ...
                    <Card>
                      <CardContent>
                        <GridContainer>
                          ...
                          <GridItem className={classes.root} xs={12} sm={12} md={12}>
                            <Typography className={classes.subTitle} variant={"h6"}>Upload Supporting
                          ...
                          {this.state.documents.map((doc, index) => {
                            return <GridItem key={index} className={classes.root} sm={12} xs={12} md={8}>
                              <FileUpload
                          ...
                          <GridItem xs={12} sm={12} md={12}>
                            <FormControlLabel
                                ...
                                control={
                                  <Checkbox style={{marginTop: 20}} color={"primary"}
                      ...
                      <CardActions disableActionSpacing={true}>
                        <GridContainer justify={"flex-end"}>
                          <GridItem>
                            <Button name={"primary"} disabled={this.invalid()}
