        ...
        <Card>
          ...
          <CardContent>
            <FormControl variant="outlined" fullWidth={true}>
              ...
              <TextField required={true} placeholder={"eg: Name"} variant={"outlined"} label={"Name of applicant"}
                         fullWidth={true} margin={"dense"}/>
              <TextField required={true} variant={"outlined"} label={"Name of Shop or Firm"} fullWidth={true}
                         margin={"dense"}/>
              <TextField required={true} variant={"outlined"} label={"Name of Trade"} fullWidth={true}
                         margin={"dense"}/>
            ...
            <FormControl variant="outlined" fullWidth={true}>
              ...
              <TextField required={false} variant={"outlined"} label={"Tin No (If any)"} fullWidth={true}
                         margin={"dense"}/>
              <TextField required={false} variant={"outlined"} label={"CST No (If any)"} fullWidth={true}
                         margin={"dense"}/>
              <TextField required={false} variant={"outlined"} label={"PAN No (If any)"} fullWidth={true}
                         margin={"dense"}/>
              <TextField required={true} variant={"outlined"} label={"Whether premises owned or Leased?"}
                         fullWidth={true} margin={"dense"}/>
              <TextField required={true} variant={"outlined"} label={"Name of Shop or Firm"} fullWidth={true}
                         margin={"dense"}/>
              <TextField required={true} variant={"outlined"} label={"Name of Shop or Firm"} fullWidth={true}
