...
class ChangeForm extends Component {
  ...
  componentDidMount() {
    ...
    Promise.all([self.fetchTrades(), self.fetchLocalCouncil()]).finally(
      function() {
          ...
          <Card>
            <CardContent>
              ...
              >
                ...
                <Grid
                  style={{
                    display: selectedFields["owner"] ? "block" : "none"
                  }}
                  item={true}
                  xs={12}
                  sm={12}
                ...
                <Grid
                  style={{
                    display: selectedFields["phone"] ? "block" : "none"
                  }}
                  item={true}
                  xs={12}
                  sm={12}
                ...
                <Grid
                  item={true}
                  style={{ display: selectedFields["type"] ? "block" : "none" }}
                  xs={12}
                  sm={12}
                  md={6}
                >
                ...
                <Grid
                  item={true}
                  style={{
                    display: selectedFields["email"] ? "block" : "none"
                  }}
                  xs={12}
                  sm={12}
                  md={6}
                ...
                <Grid
                  item={true}
                  style={{
                    display: selectedFields["owner_address"] ? "block" : "none"
                  }}
                  xs={12}
                  sm={12}
                  md={6}
                ...
                <Grid
                  item={true}
                  style={{ display: selectedFields["name"] ? "block" : "none" }}
                  xs={12}
                  sm={12}
                  md={6}
                >
                ...
                <Grid
                  item={true}
                  style={{
                    display: selectedFields["trade"] ? "block" : "none"
                  }}
                  xs={12}
                  sm={12}
                  md={6}
                ...
                <Grid
                  item={true}
                  style={{
                    display: selectedFields["address"] ? "block" : "none"
                  }}
                  xs={12}
                  sm={12}
                  md={6}
                ...
                <Grid
                  item={true}
                  style={{
                    display: selectedFields["local_council"] ? "block" : "none"
                  }}
                  xs={12}
                  sm={12}
                  md={6}
                ...
                <Grid
                  item={true}
                  style={{
                    display: selectedFields["coordinate"] ? "block" : "none"
                  }}
                  xs={12}
                  sm={12}
                  md={6}
                ...
                <Grid
                  item={true}
                  style={{
                    display: selectedFields["details"] ? "block" : "none"
                  }}
                  xs={12}
                  sm={12}
                  md={6}
                ...
                <Grid
                  item={true}
                  style={{
                    display: selectedFields["ac_rooms"] ? "block" : "none"
                  }}
                  xs={12}
                  sm={12}
                  md={6}
                ...
                <Grid
                  item={true}
                  style={{
                    display: selectedFields["non_ac_rooms"] ? "block" : "none"
                  }}
                  xs={12}
                  sm={12}
                  md={6}
                >
                  <TextField
                    ...
                    fullWidth={true}
                    onChange={event =>
                      onChange("non_ac_rooms", event.target.value)
                    }
                ...
                <Grid
                  item={true}
                  style={{
                    display: selectedFields["conference_halls"]
                      ? "block"
                      : "none"
                  }}
                  xs={12}
                ...
                >
                  <TextField
                    ...
                    fullWidth={true}
                    onChange={event =>
                      onChange("conference_halls", event.target.value)
                    }
                ...
                <Grid
                  item={true}
                  style={{
                    display: selectedFields["banquet_halls"] ? "block" : "none"
                  }}
                  xs={12}
                  sm={12}
                  md={6}
                >
                  <TextField
                    ...
                    fullWidth={true}
                    onChange={event =>
                      onChange("banquet_halls", event.target.value)
                    }
                ...
                <Grid
                  item={true}
                  style={{
                    display: selectedFields["other_facilities"]
                      ? "block"
                      : "none"
                  }}
                  xs={12}
                ...
                >
                  <TextField
                    ...
                    fullWidth={true}
                    onChange={event =>
                      onChange("other_facilities", event.target.value)
                    }
                ...
                <Grid
                  item={true}
                  style={{ display: selectedFields["estd"] ? "block" : "none" }}
                  xs={12}
                  sm={12}
                  md={6}
                >
                ...
                <Grid
                  item={true}
                  style={{
                    display: selectedFields["tin_no"] ? "block" : "none"
                  }}
                  xs={12}
                  sm={12}
                  md={6}
                ...
                <Grid
                  item={true}
                  style={{
                    display: selectedFields["cst_no"] ? "block" : "none"
                  }}
                  xs={12}
                  sm={12}
                  md={6}
                ...
                <Grid
                  item={true}
                  style={{
                    display: selectedFields["pan_no"] ? "block" : "none"
                  }}
                  xs={12}
                  sm={12}
                  md={6}
                ...
                <GridItem
                  style={{
                    display: selectedFields["gst_no"] ? "block" : "none"
                  }}
                  xs={12}
                  sm={12}
                  md={6}
                ...
                <Grid
                  item={true}
                  style={{
                    display: selectedFields["premise_type"] ? "block" : "none"
                  }}
                  xs={12}
                  sm={12}
                  md={6}
                >
                  <FormControl fullWidth={true} margin={"dense"}>
                    ...
                    <RadioGroup
                      ...
                      onChange={event =>
                        onChange("premise_type", event.target.value)
                      }
                    >
                      <FormControlLabel
                        value={"Owned"}
                ...
                <Grid
                  item={true}
                  style={{
                    display: selectedFields["passport"] ? "block" : "none"
                  }}
                  xs={12}
                  sm={12}
                  md={6}
