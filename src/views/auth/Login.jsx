        ...
        axios.post(ApiRoutes.LOGIN_ROUTE, data)
            .then(response => {
                if (response.status) {
                    ...
                    new SingletonAuth().setCurrentUser(user);
                    if (user.advertiser) {
                            ...
                            <Card login className={classes[this.state.cardAnimaton]}>
                                ...
                                <CardFooter className={classes.justifyContentCenter}>
                                    <Grid container direction="column"
                                          ...
                                          alignItems="center">
                                        <Grid item>
                                            <Button color="primary" round onClick={this.handleLogin.bind(this)}>
                                                Login
                                            </Button>
                                        </Grid>
                                        <Grid item>
                                            ...
                                            <Button simple onClick={this.handleRegister.bind(this)} color="primary"
                                                    round>
                                                Create an account?
                                            </Button>
                                        </Grid>
