...
class KioskApplicationDialog extends Component {
  getView = () => {
    ...
    const { kiosk, documents } = application;
    return (
      <>
        <GridContainer>
              ...
              <List dense={false}>
                <ListItem button={true} dense={false}>
                  <ListItemText
                    ...
                    secondary={moment(kiosk.created_at).format("Do MMM YYYY")}
                  />
                </ListItem>
                <ListItem button={true} dense={false}>
                  <ListItemText
                    primary={"Purposed Location"}
                    secondary={kiosk.address}
                  />
                </ListItem>
                <ListItem button={true} dense={false}>
                  <ListItemText
                    primary={"Local Council"}
                    secondary={kiosk.local_council.name}
                  />
                </ListItem>
                <ListItem button={true} dense={false}>
                  <ListItemText
                    primary={"Length"}
                    secondary={kiosk.length + " ft"}
                  />
                </ListItem>
                <ListItem button={true} dense={false}>
                  <ListItemText
                    primary={"Height"}
                    secondary={kiosk.height + " ft"}
                  />
                </ListItem>
                <ListItem button={true} dense={false}>
                  <ListItemText
                    primary={"Type of Display"}
                    secondary={kiosk.display_type}
                  />
                </ListItem>
                <ListItem button={true} dense={false}>
                  <ListItemText
                    primary={"Both Sided"}
                    secondary={kiosk.both_side ? "Yes" : "No"}
                  />
                </ListItem>
                <ListItem button={true} dense={false}>
                  <ListItemText
                    primary={"Collapsible"}
                    secondary={kiosk.collapsible ? "Yes" : "No"}
                  />
                </ListItem>
                <ListItem button={true} dense={false}>
                  <ListItemText
                ...
                <ListItem button={true} dense={false}>
                  <ListItemText
                    ...
                    secondary={
                      kiosk.ground_clearance ? kiosk.ground_clearance : "NA"
                    }
                  />
                </ListItem>
                <ListItem button={true} dense={false}>
                  <ListItemText
                    primary={"Landlord / Land owner"}
                    secondary={kiosk.land_owner_name}
                  />
                </ListItem>
                <ListItem button={true} dense={false}>
                  <ListItemText
