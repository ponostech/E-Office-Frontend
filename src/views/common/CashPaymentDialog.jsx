  ...
  render() {
    ...
    return (
      ...
      >
        <AppBar className={classes.appBar}>
          <Toolbar>
            <IconButton
              href={"#"}
              color="inherit"
              onClick={event => this.handleClose("close")}
              aria-label="Close"
            >
              <CloseIcon />
            </IconButton>
        ...
        <DialogContent>
          <>
            <DetailViewRow
              ...
              secondary={challan ? challan.number : ""}
            >
        ...
        <DialogActions>
          <Button
            disabled={!Boolean(this.state.comment)}
            href={"#"}
            variant={"outlined"}
            color={"primary"}
            onClick={event => this.handleClose("confirm")}
          >
            Confirm Payment
          </Button>
          <Button
