...
class KioskRejectedList extends Component {
  ...
  getData = () => {
    axios
      .get(KIOSK_LIST, { params: { status: "reject" } })
  ...
  confirmTakeFile = () =>
    axios.post(FILE_TAKE(this.state.singleData.file.id)).then(res => {
      ...
      },
      {
        ...
        options: {
          customBodyRender: value =>
            value.desk.staff.name + " (" + value.desk.staff.designation + ")"
        }
      },
      {
        name: "id",
          ...
          customBodyRender: (value, tableMeta) => {
            ...
            return (
              <>
                ...
                >
                  <Icon fontSize="medium">remove_red_eye</Icon>
                </IconButton>
                <IconButton
                  variant="contained"
                  color="secondary"
...
export default withRouter(withStyles(styles)(KioskRejectedList));
