...
class KioskApprovedList extends Component {
  ...
  getData = () => {
    axios
      .get(KIOSK_LIST, { params: { status: "approve" } })
  ...
  confirmTakeFile = () =>
    axios.post(FILE_TAKE(this.state.singleData.file.id)).then(() => {
...
export default withRouter(withStyles(styles)(KioskApprovedList));
