...
class KioskNewList extends Component {
  ...
  getData = () => {
    axios
      .get(KIOSK_LIST, { params: { status: "new" } })
  ...
  confirmTakeFile = () =>
    axios.post(FILE_TAKE(this.state.singleData.kiosk.file.id)).then(() => {
  ...
  render() {
    ...
    const tableColumns = [
      ...
      },
      {
        ...
        label: "FILE LOCATION",
        options: {
          customBodyRender: kiosk =>
            kiosk.file.desk
              ? kiosk.file.desk.staff.name +
                " (" +
                kiosk.file.desk.staff.designation +
                ")"
              : "Not on any desk"
        }
      },
