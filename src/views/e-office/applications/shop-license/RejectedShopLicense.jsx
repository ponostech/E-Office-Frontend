...
class RejectedShopLicense extends React.Component {
  ...
  componentDidMount() {
    ...
    this.shopService.fetch("rejected")
      .then(shops => {
  ...
  render() {
    ...
    return (
      <>
        <Grid item xs={12}>
          <MUIDataTable
            title={"SHOP LICENSE: List of Rejected Application"}
            data={shops}
...
export default withStyles(styles)(RejectedShopLicense);
