...
import ApplyShopDialog from "../../form/ApplyShopDialog";
...
class ShopLicenseApplications extends Component {
  state = {
    openDetail: false,
    openApply: false
  };
    ...
    return (
      <>
        <Grid item sm={12} xs={12} md={12}>
          <MUIDataTable
            title={"Shop License: List of applications"}
            data={data}
            columns={tableColumns}
            options={tableOptions}
          />
          <ApplyShopDialog open={this.state.openApply} onClose={(e) => this.setState({ openApply: false })}/>
          <ShopDetailDialog open={this.state.openDetail} onClose={(e) => this.setState({ openDetail: false })}/>
        </Grid>
...
export default withRouter(ShopLicenseApplications);
