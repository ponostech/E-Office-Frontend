...
const model = {
  ...
  date: "12/12/2019",
  applicationNo: "Hotel/Lodging License",
  status: "new",
  documents: [
    {
...
class HotelApplicationDetail extends Component {
  getDocuments = (docs) => {
    let view = undefined;
  ...
  render() {
    const {open, onClose, hotel} = this.props;
    return (
      <Dialog open={open} onClose={onClose} fullWidth={true} maxWidth={"md"}>
        <DialogContent>
          <Card>
            <CardHeader title={`Application No : ${model.applicationNo}`}
                        subheader={`Subject : ${model.subject}`}
                        action={
...
export default withStyles(style)(HotelApplicationDetail);