...
class ShopApplicationDetail extends Component {
  getDocuments = (docs) => {
    let view = undefined;
  ...
  render() {
    const {open, onClose, shop} = this.props;
    return (
...
export default withStyles(style)(ShopApplicationDetail);