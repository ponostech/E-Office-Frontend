...
class HotelInProcessList extends React.Component {
    state = {
        hotels: [],
        openMap: false,
        staffs: null,
        ...
        return (
          <>
              {loading ? <LoadingView/> : <Grid item xs={12}>
                  <MUIDataTable
                    title={"HOTEL/LODGING: List of Under Process Application"}
                    data={hotels}
...
export default withRouter(withStyles(styles)(HotelInProcessList));
