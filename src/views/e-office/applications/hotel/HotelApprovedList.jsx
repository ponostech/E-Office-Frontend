...
class HotelApprovedList extends React.Component {
  ...
  componentDidMount() {
    ...
    doLoad(true);
    this.hotelService.fetch(ApplicationState.APPROVED_APPLICATION)
      .then(hotels => {
  ...
  render() {
    ...
    if (!this.state.loading)
      table = <MUIDataTable
        title={"Hotel/Lodging LICENSE: List of Approved Applications"}
        data={hotels}
...
export default withStyles(styles)(HotelApprovedList);
