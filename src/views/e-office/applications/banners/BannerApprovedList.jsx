...
class BannerApprovedList extends React.Component {
  ...
  componentDidMount() {
    ...
    this.bannerService.fetch(ApplicationState.APPROVED_APPLICATION)
      .then(banners => {
...
export default withStyles(styles)(BannerApprovedList);
