...
class BannerDetailDialog extends Component {
      ...
      <GridContainer style={{padding:20}}>
        <GridItem justify={"space-between"} className={classes.item} md={12}>
          <GridContainer justify={"space-between"}>
            <Typography variant={"title"}>Shop License Application Detail</Typography>
...
export default withStyles(style)(BannerDetailDialog);