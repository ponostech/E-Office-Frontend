...
class AdvertiserApprovedList extends React.Component {
    state = {
        advertisers: [],
    ...
    getData() {
        this.advertiserService.fetch(ApplicationState.APPROVED_APPLICATION,
    ...
    render() {
        ...
        return (
            <>
                <Grid item xs={12}>
                    <MUIDataTable
                        title={"ADVERTISER: List of Approved Application"}
...
export default withStyles(styles)(AdvertiserApprovedList);
