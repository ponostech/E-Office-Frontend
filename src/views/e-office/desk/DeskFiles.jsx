      ...
      <GridContainer>
        <GridContainer justify={"space-between"}>
            <GridItem style={{marginBottom:20}}>
              ...
              <GridItem style={{marginBottom:20}}>
                <Tooltip title={"View"}>
                  <IconButton disabled={Boolean(this.state.file)} onClick={(e)=>history.push(OfficeRoutes.FILE_DETAIL)}>
                    <EyeIcon/>
                  </IconButton>
                </Tooltip>
              <Tooltip title={"Edit"}>
              ...
              <Tooltip title={"Forward"}>
                <IconButton disabled={Boolean(this.state.file)} onClick={(e)=>this.setState({openFileMovement:true})}>
                  <SentIcon/>
                </IconButton>
              </Tooltip>
              <Tooltip title={"Create Notesheet"}>
                <IconButton disabled={Boolean(this.state.file)} onClick={(e)=>this.setState({openNote:true})}>
                  <NoteIcon/>
                </IconButton>
              </Tooltip>
              <Tooltip title={"Create Draft"}>
                <IconButton disabled={Boolean(this.state.file)} onClick={(e)=>this.setState({openDraft:true})}>
                  <DraftIcon/>
                </IconButton>
              </Tooltip>
              <Tooltip title={"Attach Receipt"}>
                <IconButton disabled={Boolean(this.state.file)} onClick={(e)=>this.setState({openReceipts:true})}>
                  <ListIcon/>
                </IconButton>
              </Tooltip>
