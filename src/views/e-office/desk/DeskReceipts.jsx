...
import AttachReceiptDialog from "../receipt/movement/AttachReceiptDialog";
  ...
  render() {
    ...
    return (
      <GridContainer>
        ...
        <AttachReceiptDialog open={this.state.openReceiptMovement} onClose={this.handleReceiptMove.bind(this)}
