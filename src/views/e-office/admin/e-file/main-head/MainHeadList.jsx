...
class MainHeadList extends Component {
  ...
  onCreate = data => {
    this.setState({
      submitTitle: "Creating Main Head",
      openCreate: false,
      submit: true
    });
    this.fileHeadService
              ...
              <>
                <Tooltip title={"Edit"}>
                  <IconButton
                    href={"#"}
                    onClick={event =>
                      this.setState({ openEdit: true, selectedMainHead })
                    }
                  >
                ...
                <Tooltip title={"Delete"}>
                  <IconButton
                    href={"#"}
                    onClick={event =>
                      this.setState({ confirmDelete: true, selectedMainHead })
                    }
                  >
        ...
        <MuiThemeProvider theme={this.props.theme}>
          {this.global.loading ? (
            ...
            <CardContent>
              ...
              />
              <Tooltip
                title="Create New Main Head"
                aria-label="Add New Group Head"
              >
                <Fab
