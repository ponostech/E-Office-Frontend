...
class TechnicalPersonRejectTemplate extends Component {
  ...
  componentDidMount() {
    ...
    this.rejectTemplateService.get("technical-person",
  ...
  doUpdate = () => {
    ...
    this.rejectTemplateService.update(template, errorMsg => this.setState({ errorMsg }),
...
export default TechnicalPersonRejectTemplate;