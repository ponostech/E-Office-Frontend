...
class NotesheetDialog extends Component {
        ...
        <Card>
          ...
          <CardContent>
            ...
            <TextField variant={"standard"} name={"date"} label={"Subject"}
                       fullWidth={true}/>
            <TextField multiline={true} variant={"standard"} rows={10} name={"date"} label={"Subject"}
                       fullWidth={true}/>
...
NotesheetDialog.propTypes = {
  open: PropTypes.bool.isRequired,
  onClose: PropTypes.func.isRequired
};

export default NotesheetDialog;