...
class FileDraftCancelDialog extends Component {
  state = {
    content: '',
    loading: true,
    errorMsg: null,
  ...
  getData = () => {
    axios.get(GET_CANCEL_TEMPLATE(this.props.module))
        .then(res => {
  ...
  render() {
    ...
    return (
        <>
          <DialogWrapper title="Create Draft Cancel" action={action} open={open} onClose={onClose}
