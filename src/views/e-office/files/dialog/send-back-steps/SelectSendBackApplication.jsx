...
import { Button, CardHeader, Icon, List, Paper } from "@material-ui/core";
  ...
  render() {
    ...
    return (
      <GridContainer>
        ...
        <GridItem xs={12} sm={12} md={6}>
          {selectedApplication &&  <List>{ApplicationResolver(selectedApplication).map(value => <DetailViewRow primary={value.name} secondary={value.value}/>)}</List>}
        </GridItem>
