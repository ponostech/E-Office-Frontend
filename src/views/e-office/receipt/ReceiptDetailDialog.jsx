        ...
        <DialogContent>
          ...
          <GridContainer>
            <GridItem md={6} lg={6}>
              ...
              <DetailViewRow primary={"Receipt No"} secondary={receipt? receipt.no :"NA"}/>
              ...
              <DetailViewRow primary={"Letter Date"} secondary={receipt? moment(receipt.letter_date).format("Do MMM YYY") :"NA"}/>
              <DetailViewRow primary={"Received On"} secondary={receipt? moment(receipt.received_date).format("Do MMM YYY") :"NA"}/>
            ...
            <GridItem md={6} lg={6}>
              ...
              <Paper style={{ margin: 10, padding: 20 }}>
                <object style={{ height: "80vh" }} data={receipt?receipt.document:undefined} type="application/pdf" width="100%"
                        height="100%">
