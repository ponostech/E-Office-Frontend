...
class HoardingAvailableList extends Component {
  ...
  componentDidMount() {
    ...
    const self = this;
    Promise.all([this.fetchHoardings(), this.fetchDocument()]).finally(() => {
      self.setGlobal({ loading: false });
    });
  }

  fetchHoardings = async () => {
    await this.hoardingService.fetchAdvertiserHoarding(
        ...
        {this.global.loading ? (
          ...
          <Grid item sm={12} xs={12} md={12}>
            ...
            <HoardingApplyDialog
              ...
              onConfirm={this.applyHoarding.bind(this)}
              application={this.state.hoarding}
            />
            <HoardingViewDialog
