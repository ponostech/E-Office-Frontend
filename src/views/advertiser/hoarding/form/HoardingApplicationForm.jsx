...
class HoardingApplicationForm extends Component {
  ...
  handleBlur = e => {
    ...
    switch (name) {
      ...
      case "coordinate":
        !Boolean(value)
          ? this.setState({ coordinateError: "Coordinate is required" })
          : this.setState({ coordinateError: "" });
        break;
      case "category":
        !Boolean(value)
          ? this.setState({ categoryError: "Area's category is required" })
          : this.setState({ categoryError: "" });
        break;
      default:
        break;
                  ...
                  <GridContainer>
                    <GridItem className={classes.root} xs={12} sm={12} md={12}>
                      <Typography variant={"h5"}>
                        {HoardingApplicationFormModel.TITLE}
                      </Typography>
