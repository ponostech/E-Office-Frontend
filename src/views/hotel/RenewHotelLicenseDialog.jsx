...
class RenewHotelLicenseDialog extends Component {
  ...
  componentWillReceiveProps(nextProps, nextContext) {
    ...
    if (license) {
      this.hotelService.get(license.permitable_id,
  ...
  setApplication = (application) => {
    if (application) {
      ...
      this.setState({
        ...
        noConferenceHall: application.conference_halls,
        noBanquet: application.banquet_halls,
        facilities: application.other_facilities,
...
RenewHotelLicenseDialog.propTypes = {
...
export default withRouter(withStyles(style)(RenewHotelLicenseDialog));