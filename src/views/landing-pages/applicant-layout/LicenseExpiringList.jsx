        ...
        options: {
          customBodyRender: (val, meta) => {
            ...
            if (selectedPermit.is_applied)
              toBeReturned = (
                <Chip
                  size="small"
                  color="primary"
                  label="Renewal Applicaton already Submitted"
                />
              );
            ...
            return (
              <>
                {toBeReturned}
                {valid_upto < current_time ? (
                  <Chip size="small" color="secondary" label="Expired" />
                ) : (
        ...
        options: {
          customBodyRender: (val, meta) => {
            ...
            return (
              <IconButton
                href={"#"}
                onClick={event => this.openRenewDialog(selectedPermit)}
              >
    ...
    return (
      <>
        ...
        <RenewShopLicenseDialog
          onClose={() => this.setState({ openShopRenew: false })}
          license={selectedPermit}
          open={openShopRenew}
          onResubmit={this.renewShopPermit}
        />
        <RenewHotelLicenseDialog
          onClose={() => this.setState({ openHotelRenew: false })}
          license={selectedPermit}
          open={openHotelRenew}
